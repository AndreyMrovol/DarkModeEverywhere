...
public class DarkConfig {
    ...
    public static class Client extends ConfigClass {
        ...
        public ForgeConfigSpec.ConfigValue<List<? extends String>> BLOCK_FONT_RECOLOR;
        ...
        public Client() {
            ...
            List<String> blockFontRecolor = new ArrayList<>(Arrays.asList(
            ...
            BLOCK_FONT_RECOLOR = BUILDER.comment("Block font recoloring in darkened GUIs").defineList(
                    "BLOCK_FONT_RECOLOR", blockFontRecolor, blacklistElementValidator);
